      ...
      <section className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-16">
        <Card className="space-y-4 bg-white/90">
          ...
          <p className="text-sm text-muted-foreground">
            En ElSaltoWeb tratamos datos personales para operar el sistema de
            marca, onboarding y conexion de redes sociales. Solo procesamos
            informacion necesaria para prestar el servicio.
          </p>

          <div className="space-y-2 text-sm">
            <p className="font-semibold">Datos que podemos procesar</p>
            <p>
              Nombre, email, datos de cuenta social conectada, contenido
              autorizado y metadatos tecnicos.
            </p>
          </div>
          ...
          <div className="space-y-2 text-sm">
            ...
            <p>
              Gestion de cuentas, analitica de rendimiento, soporte, seguridad y
              mejora del producto.
            </p>
          </div>
          ...
          <div className="space-y-2 text-sm">
            ...
            <p>
              Conservamos los datos mientras exista relacion activa de servicio
              o hasta recibir una solicitud valida de eliminacion.
            </p>
          </div>
