      ...
      <section className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-16">
        <Card className="space-y-4 bg-white/90">
          ...
          <p className="text-sm text-muted-foreground">
            Al usar redes.elsaltoweb.es aceptas estos terminos. Si no estas de
          ...
          <div className="space-y-2 text-sm">
            ...
            <p>
              Debes usar el servicio de forma legal, sin intentar acceder a
              cuentas o datos de terceros sin autorizacion.
            </p>
          </div>
          ...
          <div className="space-y-2 text-sm">
            ...
            <p>
              Puedes revocar en cualquier momento conexiones con plataformas
              externas desde tu panel o desde la propia plataforma de terceros.
            </p>
          </div>
          ...
          <div className="space-y-2 text-sm">
            ...
            <p>
              El servicio puede tener mantenimiento, cambios o interrupciones
              sin garantia de disponibilidad continua.
            </p>
          </div>
