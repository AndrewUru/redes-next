  ...
  return (
    <div className="space-y-5" role="status" aria-label="Cargando clientes">
        ...
        <Card className="bg-[#fef3c7]">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="flex w-full gap-2 lg:max-w-md">
              <Skeleton className="h-11 flex-1 bg-surface/80" />
              <Skeleton className="h-11 w-24 bg-surface/80" />
            </div>
          </div>
        </Card>

        <div className="grid gap-3 sm:grid-cols-3 xl:grid-cols-1">
          {["bg-surface/80", "bg-[#dcfce7]", "bg-[#dbeafe]"].map(
            (className) => (
              <div
                key={className}
      ...
      <Card>
        ...
        <div className="overflow-hidden rounded-[8px] border-2 border-border bg-surface/75">
